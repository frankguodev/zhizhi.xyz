...
export function AdminSelect({ ariaLabel, className, options, value, onChange }: AdminSelectProps) {
  ...
  return (
    <div ref={rootRef} className={cn("relative", className)}>
      <button
        ...
        className={cn(
          "flex h-11 w-full cursor-pointer items-center justify-between gap-3 rounded-md border bg-background px-3 text-left text-sm outline-none transition",
          open ? "border-accent bg-paper shadow-[0_0_0_3px_color-mix(in_srgb,var(--accent)_14%,transparent)]" : "border-line hover:border-accent/45",
        )}
        type="button"
        onClick={() => {
          if (!open) {
