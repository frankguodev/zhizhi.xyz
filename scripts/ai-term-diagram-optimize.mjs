...
Optimizes a local AI term diagram to WebP, prefers 1600x900, falls back to 1280x720, and enforces <=100KB.`);
}
...
async function main() {
  ...
  console.log(`Limit: <=${Math.round(getMaxBytes() / 1024)}KB, ${describeOptimizedDiagramSizes()}`);
}
