...
short_desc: "MCP 是 Model Context Protocol 的缩写，用来让 AI 应用以统一方式连接工具、数据源和外部系统，常见于 Agent、AI Coding 和企业 AI 集成场景。"
tagline: "MCP 被形容称为 AI 领域的 USB 接口。"

beginner_notes:
  plain_explanation: "MCP 是 AI 应用连接外部世界的一套通用协议，让模型能按规则访问工具、资料和系统。"
  analogy: "它像一套标准化工作台，把文档、工具箱、数据库和操作按钮摆到 AI 应用能识别的位置。"
  why_it_matters: "MCP 代表 AI 从聊天窗口走向真实工具和工作流，影响 Agent、AI Coding 和企业 AI 集成。"
  common_misconception: "MCP 不是新模型，也不是万能插件市场；它只规定连接方式，安全性仍取决于实现和权限设计。"
...
categories:
  - name: "AI Infra"
    slug: "ai-infra"
    description: "AI 应用、Agent 和工具生态背后的基础设施与连接层。"
    sort_order: 10
  - name: "Agent"
    slug: "agent"
    description: "围绕 AI Agent、工具调用和自主工作流的概念与实践。"
    sort_order: 20
...
seo:
  ...
  description: "MCP 是让 AI 应用连接外部工具、资料和系统的开放协议，常见于 Agent、AI Coding 和企业 AI 集成场景。本文适合想理解 AI 工具生态、上下文连接和模型工具调用的新手与独立开发者。"
  keywords:
    - "MCP"
...
open_graph:
  title: "MCP 是什么：AI 应用连接外部世界的通用协议"
  description: "了解 MCP 为什么在 Agent 和 AI Coding 生态中变热，以及它和工具调用、外部数据源、安全风险的关系。"
  type: "article"
  image: ""
  image_alt: ""
...
twitter:
  ...
  title: "MCP 是什么"
  description: "MCP 是 Model Context Protocol，一种让 AI 应用连接工具和上下文的开放协议。"
  image: ""

source:
  source_note: "基于资料归档和人工二创稿整理为可导入发布稿，发布前建议再次复核官方资料。"
  ai_assisted: true
  human_reviewed: true
...
structured_data:
  ...
  name: "MCP"
  alternate_name: "Model Context Protocol, 模型上下文协议, MCP protocol"
  description: "MCP 是一种开放协议，用于标准化 AI 应用连接外部工具、数据源和上下文的方式。"
  in_language: "zh-CN"
  publisher_name: "知之"
---
...
普通人不一定需要会写 MCP server，但值得知道 MCP 代表的方向：AI 已经从“会聊天的模型”走向“能连接工具和资料的工作伙伴”。

当你看到一个 AI 助手能读你的文档、查你的项目、连你的数据库、帮你操作某个工具时，可以多问一步：它是怎么连接的？权限怎么控制？数据会去哪里？工具调用出错怎么办？
